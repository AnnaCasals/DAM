...
public class FinestraCanviMoneda {
	...
	JButton botoEuroDolars = new JButton();
	JButton botoDolarsEuro = new JButton();
	...
	FinestraCanviMoneda() {
		...
		botoEuroDolars.setIcon(new ImageIcon("src/Recursos/flechaderecha.gif"));
		botoEuroDolars.setSize(new Dimension(50, 50));
		botoEuroDolars.addActionListener(new CalcEuroDolar(txtEuros, txtDolars));
		
		botoEuroDolars.setIcon(new ImageIcon("src/Recursos/flechaizquierda.gif"));
		botoDolarsEuro.setSize(new Dimension(50, 50));
		botoDolarsEuro.addActionListener(new CalcDolarEuro(txtDolars, txtEuros));
		
		marBotons.add("North", botoEuroDolars);
		marBotons.add("South", botoDolarsEuro);
